...
export default function App() {
    ...
    // handleFileChange mein intent add karein
  ...
  if (file && file.type === "application/pdf") {
    ...
    // Yahan hum decide kar sakte hain (Default: resume, but can be changed)
    // For example, agar user ne 'Summarization' card click kiya tha, toh 'summary' bhejo
    const currentIntent = "resume"; // Ise aap state se dynamic bana sakte ho
    formData.append("intent", currentIntent); 

    onSendMessage(`[Processing PDF: ${file.name}]`, formData);
  }
};
